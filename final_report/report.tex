...
In all of the following plots, we report the \textit{running} average reward per cycle, and the \textit{rolling} average reward per cycle, which are defined as 

\begin{align*}
\bar{R}^\text{running}_t = \frac{1}{t}\sum_{i=1}^{t}{R_i} 
